...
export const REEL = {
  ...
  photos: [
    ...
    { file: 'assets/photos/ire_beautiful.jpg',      caption: 'hey gorgeuous' },
    { file: 'assets/photos/couple_train.jpg',       caption: 'on our way somewhere.' },
    { file: 'assets/photos/couple_vatican.jpg',     caption: 'oh cool place.' },
    { file: 'assets/photos/couple_lunch.jpg',       caption: '' },
    { file: 'assets/photos/couple_playing.jpg',     caption: 'miss beating your ass... i mean..' },
    { file: 'assets/photos/couple_her_b_day.jpg',   caption: 'happy birthday.' },
    { file: 'assets/photos/couple_bed.jpg',         caption: '' },
    { file: 'assets/photos/couple_bed_2.jpg',       caption: 'my baby' },
    { file: 'assets/photos/couple_cute.jpg',        caption: 'I think we are cute' },
    { file: 'assets/photos/couple_cute_2.jpg',      caption: 'perfect' },
    { file: 'assets/photos/couple_cute_3.jpg',      caption: 'i miss you love' },
    { file: 'assets/photos/couple_cute_4.jpg',      caption: 'did you know i had this?' },
    { file: 'assets/photos/couple_cute_5.jpg',      caption: 'i miss you so much' },
    { file: 'assets/photos/couple_cute_7.jpg',      caption: 'a little step in our journey' },
    { file: 'assets/photos/couple_cute_6.jpg',      caption: 'i love you' },
    ...
    { file: 'assets/photos/couple_2.jpg',           caption: 'coffee?' },
    { file: 'assets/photos/couple_fun_1.jpg',       caption: '' },
    { file: 'assets/photos/couple_funny_2.jpg',     caption: 'boo' },
    { file: 'assets/photos/her_funny.jpg',          caption: '' },
    { file: 'assets/photos/her_funny_2.jpg',        caption: 'my womman' },
    { file: 'assets/photos/her_pretty.jpg',         caption: '' },
    { file: 'assets/photos/ire_funny.jpg',          caption: '...sorry' },
    { file: 'assets/photos/couple_my_favorite.jpg', caption: 'you are my dream, happy valentines <3' }, // MUST stay last
  ],
  perPhotoMs: 4000,
  finalPhotoMs: 6500,
  crossfadeMs: 800,
